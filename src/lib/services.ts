...
export const services: Service[] = [
  {
    ...
    premium: false,
    icon: 'emergency',
    image: '/images/services/service-emergency.webp',
    galleryImage: '/images/gallery/gallery-emergency-fix.webp',
  ...
  },
  {
    ...
    premium: true,
    icon: 'bathroom',
    image: '/images/services/service-bathroom.webp',
    galleryImage: '/images/gallery/gallery-bathroom-fit.webp',
  ...
  },
  {
    ...
    premium: true,
    icon: 'boiler',
    image: '/images/services/service-boiler-install.webp',
    galleryImage: '/images/gallery/gallery-boiler-install.webp',
  ...
  },
  {
    ...
    premium: false,
    icon: 'boiler-repair',
    image: '/images/services/service-boiler-repair.webp',
    galleryImage: '/images/gallery/gallery-heating-system.webp',
  ...
  },
  {
    ...
    premium: false,
    icon: 'drain',
    image: '/images/services/service-drain.webp',
    galleryImage: '/images/gallery/gallery-extension-plumbing.webp',
  ...
  },
  {
    ...
    premium: false,
    icon: 'leak',
    image: '/images/services/service-leak.webp',
    galleryImage: '/images/gallery/gallery-leak-repair.webp',
  ...
  },
  {
    ...
    premium: true,
    icon: 'wetroom',
    image: '/images/gallery/gallery-wet-room.webp',
    galleryImage: '/images/gallery/gallery-wet-room.webp',
  ...
  },
  {
    ...
    premium: true,
    icon: 'heating',
    image: '/images/services/service-heating.webp',
    galleryImage: '/images/gallery/gallery-heating-system.webp',
  ...
  },
  {
    ...
    premium: true,
    icon: 'underfloor',
    image: '/images/services/service-underfloor.webp',
    galleryImage: '/images/gallery/gallery-underfloor-heat.webp',
  ...
  },
  {
    ...
    premium: false,
    icon: 'gas',
    image: '/images/services/service-boiler.webp',
    galleryImage: '/images/gallery/gallery-gas-upgrade.webp',
