                  ...
                  {faqs.length > 0 ? faqs.map((faq, i) => {
                    ...
                    <>
                      <div className="bg-navy-800 border border-white/5 rounded-lg p-5">
                        <h3 className="text-white font-semibold mb-2">How do I get a quote for {service.name.toLowerCase()} in {town.name}?</h3>
                        <p className="text-slate-400 text-sm">Fill out the form on this page with a few details about your job, and we will connect you with a qualified local plumber serving {town.name}. You will receive a free, no-obligation quote with no call-out charge.</p>
                      </div>
                      <div className="bg-navy-800 border border-white/5 rounded-lg p-5">
